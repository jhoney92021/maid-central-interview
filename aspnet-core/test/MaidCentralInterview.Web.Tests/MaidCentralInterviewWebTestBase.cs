...
{
    public abstract class MaidCentralInterviewWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MaidCentralInterviewWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MaidCentralInterviewWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MaidCentralInterviewDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MaidCentralInterviewDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MaidCentralInterviewDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MaidCentralInterviewDbContext, Task<T>> func)
        {
            T result;
